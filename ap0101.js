...
//箱2の表示設定
  ...
  const box2Material = new THREE.MeshLambertMaterial({color: 0x006060});
  ...
  //箱3の表示設定
  const box3Geometry = new THREE.BoxGeometry(8,8,8);
  const box3Material = new THREE.MeshLambertMaterial({color: 0x001060});
